...
class TokenPair(Base):
    ...
    ath_usd = Column(Float, nullable=False, default=0.0)
    ...
    transaction_count_24_hour_min_buys = Column(Integer, nullable=False, default=0)
    transaction_count_24_hour_min_sells = Column(Integer, nullable=False, default=0)
